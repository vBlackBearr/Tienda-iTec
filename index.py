...
def NavigationBar():
    return html.nav(
        ...
        html.ul(
            {"class": "navbar-top-ul"},
            html.li({"class": "navbar-top-item"}, html.a({"href": "registro.html", "class": "navbar-top-links"}, "Registro")),
            html.li({"class": "navbar-top-item"}, html.a({"href": "login.html", "class": "navbar-top-links"}, "Iniciar sesión")),
                    ...
                    html.div({"class": "columns is-centered is-mobile is-multiline"}, [
                        ...
                        html.div({"class": "column is-half column-full"}, [
                            html.div({"class": "card"}, [
                                ...
                                html.img({"src": "img/item-1.png", "alt": ""}),
                                html.div({"class": "card-info"}, [
                                    html.h4({"class": "has-text-black has-text-centered has-text-weight-bold"}, "iPhone 14"),
                                    html.p({"class": "has-text-centered"}, "iPhone con cargador y airpods"),
                                    html.div({"class": "card-buttons"}, [
                                        html.a({"class": "btn btn--mini-rounded", "href": "#"}, html.i({"class": "zmdi zmdi-shopping-cart"})),
                                        html.a({"class": "btn btn--mini-rounded", "href": "#"}, html.i({"class": "zmdi zmdi-favorite-outline"})),
                                        html.a({"class": "btn btn--mini-rounded", "href": "producto.html"}, html.i({"class": "zmdi zmdi-eye"})),
                                    ]),
                                ]),
                            ]),
                        ]),
                        html.div({"class": "column column-full is-half"}, [
                            html.div({"class": "card"}, [
                                ...
                                html.img({"src": "img/item-2.png", "alt": ""}),
                                html.div({"class": "card-info"}, [
                                    html.h4({"class": "has-text-black has-text-centered has-text-weight-bold"}, "iPhone 14 plus"),
                                    html.p({"class": "has-text-centered"}, "iPhone con cargador y airpods"),
                                    html.div({"class": "card-buttons"}, [
                                        html.a({"class": "btn btn--mini-rounded", "href": "#"}, html.i({"class": "zmdi zmdi-shopping-cart"})),
                                        html.a({"class": "btn btn--mini-rounded", "href": "#"}, html.i({"class": "zmdi zmdi-favorite-outline"})),
                        ...
                        html.div({"class": "column is-full"}, [
                            html.div({"class": "card"}, [
                                ...
                                html.img({"src": "img/item-3.png", "alt": ""}),
                                html.div({"class": "card-info"}, [
                                    html.h4({"class": "has-text-black has-text-centered has-text-weight-bold"}, "iPhone 14 Pro"),
                                    html.p({"class": "has-text-centered"}, "iPhone con cargador y airpods"),
                                    html.div({"class": "card-buttons"}, [
                                        html.a({"class": "btn btn--mini-rounded", "href": "#"}, html.i({"class": "zmdi zmdi-shopping-cart"})),
                                        html.a({"class": "btn btn--mini-rounded", "href": "#"}, html.i({"class": "zmdi zmdi-favorite-outline"})),
                    ...
                    html.div({"class": "columns is-mobile is-multiline"}, [
                        html.div({"class": "column is-full"}, [
                            html.div({"class": "card"}, [
                                ...
                                html.img({"src": "img/item-4.png", "alt": ""}),
                                html.div({"class": "card-info"}, [
                                    html.h4({"class": "has-text-black has-text-centered has-text-weight-bold"}, "iPhone 14 Pro Max"),
                                    html.p({"class": "has-text-centered"}, "iPhone con cargador y airpods"),
                                    html.div({"class": "card-buttons"}, [
                                        html.a({"class": "btn btn--mini-rounded", "href": "#"}, html.i({"class": "zmdi zmdi-shopping-cart"})),
                                        html.a({"class": "btn btn--mini-rounded", "href": "#"}, html.i({"class": "zmdi zmdi-favorite-outline"})),
            ...
            html.div({"class": "columns is-centered is-multiline"}, [
                ...
                html.div({"class": "column is-half-tablet is-one-third-desktop column-half"}, [
                    html.div({"class": "card card-second"}, [
                        html.img({"class": "card-second-image", "src": "img/lookbook-men.png", "alt": ""}),
                        html.div({"class": "card-second-body --text-right"}, [
                            html.h1({"class": "has-text-right is-size-4 has-text-weight-semibold-bold"}, "Cupones 5% de descuento"),
                ...
                html.div({"class": "column is-half-tablet is-one-third-desktop column-half"}, [
                    html.div({"class": "card card-second"}, [
                        html.img({"class": "card-second-image", "src": "img/lookbook-women.png", "alt": ""}),
                        html.div({"class": "card-second-body --text-right"}, [
                            html.h1({"class": "has-text-right is-size-4 has-text-weight-semibold-bold"}, "Descuento del 25%"),
                ...
                html.div({"class": "column is-half-tablet is-one-third-desktop"}, [
                    html.div({"class": "card card-second"}, [
                        html.img({"class": "card-second-image", "src": "img/lookbook-you.png", "alt": ""}),
                        html.div({"class": "card-second-body --text-right"}, [
                            html.h1({"class": "has-text-right is-size-4 has-text-weight-semibold-bold"}, "Vale del 10% en todos los dispositivos"),
