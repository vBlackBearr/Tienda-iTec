                    ...
                    html.tbody({"class": "align-middle"},
                        html.tr(
                            html.td({"class": "align-middle"},
                                  ...
                                  html.img({"src": "static/img/item-1.jpg", "alt": "", "style": "width: 50px;"}),
                                  "iPhone 14 pro Max"
                                        )
                                    ),
                            html.td({"class": "align-middle"}, "$150"),
                            html.td({"class": "align-middle"},
                                html.div({"class": "input-group quantity mx-auto", "style": "width: 100px;"},
                                    html.div({"class": "input-group-btn"},
                                        html.button({"class": "btn btn-sm btn-primary btn-minus"},
                                            html.i({"class": "fa fa-minus"})
                                        )
                                    ),
                                    html.input({"type": "text", "class": "form-control form-control-sm bg-secondary text-center", "value": "1"}),
                                    html.div({"class": "input-group-btn"},
                                        html.button({"class": "btn btn-sm btn-primary btn-plus"},
            ...
            html.div({"class": "col-lg-4"},
                html.form({"class": "mb-5", "action": ""},
                    html.div({"class": "input-group"},
                        html.input({"type": "text", "class": "form-control p-4", "placeholder": "Coupon Code"}),
                        html.div({"class": "input-group-append"},
                            html.button({"class": "btn btn-primary"}, "Aplicar cupón")
                        )
                    )
                ),
