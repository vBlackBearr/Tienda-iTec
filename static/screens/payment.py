    ...
    return html.div(
     Base(
            (
                ...
                html.div({"class": "mb-4"},
                    html.h4({"class": "font-weight-semi-bold mb-4"}, "Datos del contacto"),
                    html.div({"class": "row"},
                        html.div({"class": "col-md-6 form-group"},
                            html.label("Nombre"),
                            html.input({"class": "form-control", "type": "text", "placeholder": "John"}),
                        ),
                        html.div({"class": "col-md-6 form-group"},
                            html.label("Apellido Paterno"),
                            html.input({"class": "form-control", "type": "text", "placeholder": "Doe"}),
                        ),
                        html.div({"class": "col-md-6 form-group"},
                            html.label("E-mail"),
                            html.input({"class": "form-control", "type": "text", "placeholder": "example@email.com"}),
                        ),
                        html.div({"class": "col-md-6 form-group"},
                            html.label("Telefono"),
                            html.input({"class": "form-control", "type": "text", "placeholder": "+123 456 789"}),
                        ),
                        html.div({"class": "col-md-6 form-group"},
                            html.label("Direccion 1"),
                            html.input({"class": "form-control", "type": "text", "placeholder": "123 Street"}),
                        ),
                        html.div({"class": "col-md-6 form-group"},
                        ...
                        html.div({"class": "col-md-6 form-group"},
                            ...
                            html.select({"class": "custom-select"},
                                html.option({"selected": True}, "Selecciona País"),
                                html.option("México"),
                            ),
                        ),
                        html.div({"class": "col-md-6 form-group"},
                            html.label("Estado"),
                            html.input({"class": "form-control", "type": "text", "placeholder": "New York"}),
                        ),
                        html.div({"class": "col-md-6 form-group"},
                        ...
                        html.div({"class": "col-md-6 form-group"},
                            ...
                            html.input({"class": "form-control", "type": "text", "placeholder": "12345"}),
                        ),
                    ),
                ),
            ),
            html.div({"class": "col-lg-4"},
                html.div({"class": "card border-secondary mb-5"},
                    html.div({"class": "card-header bg-secondary border-0"},
                        html.h4({"class": "font-weight-semi-bold m-0"}, "Order Total"),
                    ),
                    ...
                    html.div({"class": "card-body"},
                        html.div({"class": "form-group"},
                            html.div({"class": "custom-control custom-radio"},
                                html.input({"type": "radio", "class": "custom-control-input", "name": "payment", "id": "paypal"}),
                                html.label({"class": "custom-control-label", "for": "paypal"}, "Paypal"),
                            ),
                        ),
                        html.div({"class": "form-group"},
                            html.div({"class": "custom-control custom-radio"},
                                html.input({"type": "radio", "class": "custom-control-input", "name": "payment", "id": "directcheck"}),
                                html.label({"class": "custom-control-label", "for": "directcheck"}, "Tarjeta de Credito"),
                            ),
                        ),
                        html.div({"class": "form-group"},
                            html.div({"class": "custom-control custom-radio"},
                                html.input({"type": "radio", "class": "custom-control-input", "name": "payment", "id": "banktransfer"}),
                                html.label({"class": "custom-control-label", "for": "banktransfer"}, "Tarjeta de Debito"),
                            ),
                        ),
                    ),
                    html.div({"class": "card-footer border-secondary bg-transparent"},
                        html.button({"class": "btn btn-lg btn-block btn-primary font-weight-bold my-3 py-3"}, "Comprar"),
                          ),
                     ),
                 ),
             ),
