...
from static.admin.content.database import get_db
from static.admin.content.cruds.models.models import ProductSale
from static.admin.content.cruds.schemas.schemas import ProductSaleCreate, ProductSaleUpdate
