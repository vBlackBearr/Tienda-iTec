...
from content.database import get_db
from content.cruds.models.models import ProductSale
from content.cruds.schemas.schemas import ProductSaleCreate, ProductSaleUpdate
